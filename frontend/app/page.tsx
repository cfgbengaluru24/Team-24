...
export default function Home() {
  ...
  const handleClick = (event: React.ChangeEvent<HTMLSelectElement>): void => {
    ...
    if (divRef.current) {
      divRef.current.innerText = 'A non-profit, Charitable Trust involved in nature conservation in the Nilgiri region of South India.';
    }
  };
  ...
  return (
    <div className=''>
        ...
        <div className="flex justify-end pr-2">
          <select className='text-black p-2 rounded absolute' onChange={handleClick}>
            ...
            <div ref={divRef} className='absolute text-white text-xl mt-40 ml-5 text-justify'>
            தெற்கு இந்தியாவின் நீலகிரி பிரதேசத்தில் இயற்கை பாதுகாப்பில் ஈடுபட்டுள்ள ஒரு அன்னியா, சமூக நலன் செய்யும் நம்பிக்கையற்ற நிதி.
            </div>
        ...
        <div className=''>
      <button className="w-full h-12 px-6 text-2xl text-indigo-100 transition-colors duration-150 bg-black rounded-lg focus:shadow-outline hover:bg-green-500 mb-5">GO TO OUR MARKET PLACE</button>
        <div className='mt-30'>
